...
import CanceledStaffAppointmentCard from './CanceledStaffAppointmentCard'
...
function CanceledStaffAppointments() {
  ...
  const fetchCanceledAppointments = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get(`${BASE_URL}/appointment/staff/canceled`, {
...
export default CanceledStaffAppointments